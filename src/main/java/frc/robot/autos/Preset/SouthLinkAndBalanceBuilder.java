...
public class SouthLinkAndBalanceBuilder {
  ...
  public SouthLinkAndBalanceBuilder() {
    ...
    m_mountCSLoader =
        new TrajectoryLoader("SouthLNB_3mountCS", kDefaultMaxVelocity, kDefaultMaxAcceleration);
  }
  ...
  public CommandBase getCommand(RobotContainer botContainer) {
    ...
    String autoName = "<South Link+Balance>";
    ...
    CommandBase autoCommands =
        Commands.sequence(
            ...
            new BotLog.SimulationPrinter(autoName + " acquire C4"),
            new AutoIntakeWithZTargeting(
                ...
                c1AcquireBoundary),
            // Move and shoot C1
            new BotLog.SimulationPrinter(autoName + " move to shoot C4"),
            ...
            new BotLog.SimulationPrinter(autoName + " acquire C3"),
            new AutoIntakeWithZTargeting(
                GameTarget.Cube,
                botContainer.ArmCamera,
                swerveSubsystem,
                ...
                c2AcquireBoundary),
            // Move and shoot C2
            new BotLog.SimulationPrinter(autoName + " mount CS to shoot C3"),
