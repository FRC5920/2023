...
public class ChaseTagCommand extends CommandBase {
  ...
  public ChaseTagCommand(
      PhotonCamera photonCamera, Swerve drivetrainSubsystem, Supplier<Pose2d> poseProvider) {
  ...
  public void execute() {
    ...
    if (lastTarget == null) {
      ...
      drivetrainSubsystem.drive(
          new Translation2d(ySpeed, xSpeed).times(Constants.SwerveDrivebaseConstants.maxSpeed),
          omegaSpeed,
          true,
          true);
